...
//@icon 🔵
//@update-url https://raw.githubusercontent.com/ruyari-cupcake/cupcake-plugin-manager-test2/main/cpm-provider-gemini.js
...
(() => {
    ...
    const GEMINI_MODELS = [
        ...
        { uniqueId: 'google-gemini-3.1-flash-lite-preview', id: 'gemini-3.1-flash-lite-preview', name: 'Gemini 3.1 Flash Lite Preview' },
